    ...
    <body class="homepage-9 hp-6 homepage-1">
        ...
        <div id="wrapper">
           ...
           @include('body.header')
            ...
            <!-- STAR HEADER SEARCH -->
            @include('body.header_search')
            <!-- END HEADER SEARCH -->

            <!-- START SECTION RECENT PLACES -->
           @include('body.recent_properties')
            <!-- END SECTION RECENT PLACES -->

            <!-- START SECTION FEATURED PROPERTIES -->
          @include('body.show_properties')
            <!-- END SECTION FEATURED PROPERTIES -->

            <!-- START SECTION WHY CHOOSE US -->
            @include('body.why_choose_us')
            <!-- END SECTION WHY CHOOSE US -->

            <!-- START SECTION POPULAR PROPERTIES -->
            @include('body.popular_properties')
            <!-- END SECTION POPULAR PROPERTIES -->
            ...
            @include('body.reviews')
            <!-- END SECTION REVIEWS -->

            <!-- STAR SECTION PARTNERS -->
           @include('body.partners')
