                            ...
                            <div class="detail-wrapper-body">
                                <div class="listing-title-bar">
                                    <div class="text-heading text-left">
                                        <p class="pb-2"><a href="index.html">Panel </a> &nbsp;/&nbsp;
                                            <span>Vendedores</span></p>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div class="input-group border rounded input-group-lg w-auto mr-4">
                                            <label
                                                ...
                                                for="inputGroupSelect01"><i class="fas fa-align-left fs-16 pr-2"></i>Filtrar
                                                Por:</label>
                                            <select
                            ...
                            <div class="row portfolio-items">
                                @foreach ($sellers as $seller)
                                    <div class="item col-lg-6 col-md-6 col-xs-12 landscapes sale">
                                        <a href="{{route('seller.grid-single', $seller->id)}}" class="recent-16" data-aos="fade-up">
                                            <div class="recent-img16 img-center"
                                                style="background-image: url('{{ asset('cliente/images/interior/p-1.png') }}')">
                                            </div>
                                            <div class="recent-content"></div>
                                            <div class="recent-details">
                                                <div class="recent-title"> {{ $seller->name }}</div>
                                                <div class="recent-price">6624879464</div>
                                                <div class="house-details"> 7 Reseñas <span>|</span> 4 Ventas <span>|</span>
                                                    14 Propiedades</div>
                                            </div>
                                ...
                                <!--/ End Search Form --> --}}
                                            ...
                                            <div class="main-search-field-2">
                                                ...
                                                <div class="range-slider">
                                                    ...
                                                    <div id="price-range" data-min="0" data-max="100" data-unit="">
                                                    </div>
                                                    <div class="clearfix"></div>
                                                </div>
                                            </div>
                                            <!-- More Search Options -->
                                            <a href="#"
                                                class="more-search-options-trigger margin-bottom-10 margin-top-30"
