...
@section('admin')
    ...
    <div class="row col-sm-12">
        ...
        <div class="card card-primary col-sm-3">
            <div class="card-header">
                <h3 class="card-title">Reportes De Propiedades por Precio</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form class="reportes-form" method="POST" action="{{ route('reportes.propiedadesPrice') }}">
                @csrf
                <div class="card-body">
                    <div class="form-group">
                        <label for="precioinicial">Precio Inicial</label>
                        <input type="number" name="precioinicial" class="form-control" id="precioinicial">
                    </div>
                    <div class="form-group">
                        <label for="preciofinal">Precio Final</label>
                        <input type="number" name="preciofinal" class="form-control" id="preciofinal">
                    </div>
                </div>
                <!-- /.card-body -->
