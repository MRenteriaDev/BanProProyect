    ...
    <div class="col-md-12">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Creación de Solicitud Vendedor</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form method="POST" action="{{ route('solicitudvendedor.store') }}">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="telefono" class="form-control" id="nombre"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" name="correo" class="form-control" id="nombre"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Mensaje</label>
                                <input type="text" name="mensaje" class="form-control" id="nombre"
                                    placeholder="mensaje">
                                @error('telefono')
                                    <span class="text-danger"> {{ $message }} </span>
                                @enderror
