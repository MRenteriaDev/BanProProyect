...
@section('admin')
    <section class="content-header" style="margin-top: 10px">
        <title>Review Seller | BanPro</title>
    ...
    <div class="col-md-12">
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form method="POST" action="{{ route('reviewsellers.update', $review_seller->id) }}">
                @csrf
                <div class="card-body col-md-12">
                    <div class="form-group">
                        <label for="nombre">Nombre</label>
                        <input type="text" value="{{ $review_seller->nombre }}" name="nombre" class="form-control" id="nombre" placeholder="Enter name">
                        @error('nombre')
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" value="{{ $review_seller->descripcion }}" name="descripcion" id="descripcion" cols="10" rows="2"></textarea>
                        @error('descripcion')
                            <span class="text-danger"> {{ $message }} </span>
                        @enderror
                    </div>
