    ...
    <div class="col-md-12">
        <div class="card card-success">
            <div class="card-header">
                <h3 class="card-title">Actualización de Reviews</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form method="POST" action="{{ route('review.update', $review->id) }}">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="nombre" value="{{ $review->nombre }}" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="descripcion" id="" cols="10" rows="2">{{ $review->descripcion }}</textarea>
                        @error('descripcion')
                            <span class="text-danger"> {{ $message }} </span>
                        @enderror
                    </div>
