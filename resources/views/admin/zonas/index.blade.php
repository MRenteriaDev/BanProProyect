                    ...
                    <table id="example1" class="table table-bordered table-striped dataTable dtr-inline"
                        ...
                        <tbody>
                            ...
                            @foreach ($zonas as $zona)
                                <tr class="odd">
                                    <td class="dtr-control sorting_1" tabindex="0">{{ $zona->zona_nombre }}</td>
                                    <td>{{ $zona->created_at }}</td>
                                    <th class="row">
                                        <div class="btn-group" role="group" aria-label="Basic example">

                                            <a class="btn btn-md btn-success" href="{{ route('zonas.edit', $zona->id) }}"><i
                                                    class="fa fa-pencil" aria-hidden="true"></i>
                                            </a>

                                            <a class="btn btn-md btn-danger" href="{{ route('zonas.destroy', $zona->id) }}"
