...
@section('admin')
    ...
    <div class="col-md-12">
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form method="POST" action="{{ route('metodospagos.update', $metodospagos->id) }}">
                @csrf
                <div class="card-body col-md-12">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="nombre">Nombre</label>
                            <input type="text" name="nombre" value="{{ $metodospagos->nombre }}" class="form-control" id="nombre"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="numero_tarjeta" value="{{ $metodospagos->numero_tarjeta }}" class="form-control" id="numero_tarjeta"
                ...
                <div class="col-md-6 ml-4">
                    <div class="form-group">
                        ...
                        <input type="date" name="fecha_vencimiento" value="{{ $metodospagos->fecha_vencimiento }}" class="form-control" id="fecha_vencimiento"
                ...
                <div class="col-md-6 ml-4">
                    <div class="form-group">
                        ...
                        <input type="number" name="nip" value="{{ $metodospagos->nip }}" class="form-control" id="nip"
